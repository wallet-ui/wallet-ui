---
name: install-wallet-ui-react-native-web3js
description: Use when setting up @wallet-ui/react-native-web3js (legacy web3.js v1) in a new or existing Expo application.
---

# Install Wallet UI (React Native - Web3.js)
...
> **Note:** This package depends on the legacy `@solana/web3.js` v1 library. For new projects, we recommend using `@wallet-ui/react-native-kit` which uses the modern `@solana/kit` (see `solana-kit.md`).
