...
<Callout type="info">
    When using a public RPC endpoint for `mainnet`, be aware of rate limits. For production applications, it is highly
    recommended to use a dedicated RPC provider.
</Callout>
