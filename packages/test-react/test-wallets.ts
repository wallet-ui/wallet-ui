...
export const testWalletBackpack = {
    accounts: [
        {
...
export const testWalletPhantom = {
    accounts: [],
    chains: ['solana:mainnet', 'solana:devnet', 'solana:testnet', 'solana:localnet'],
    features: [
        'standard:connect',
...
export const testWalletSolflare = {
    accounts: [],
...
export function useTestWallets() {
    return [
        ...
        testWalletPhantom,
        testWalletSolflare,
    ] as unknown as UiWallet[]; // something with the symbol that I don't understand
}
