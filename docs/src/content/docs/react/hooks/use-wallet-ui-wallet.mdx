...
<Callout>
    For most common use cases, consider using the main [`useWalletUi`](/react/hooks/use-wallet-ui/) hook, which manages
    the currently selected wallet. This hook is for advanced use cases where you need to interact with a specific wallet
