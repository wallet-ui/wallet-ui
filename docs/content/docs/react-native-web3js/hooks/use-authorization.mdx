...
The `useAuthorization` hook is the primary hook for interacting with the wallet state. It provides access to the connected wallet, account, cluster information, and functions to connect, disconnect, and copy the address.
