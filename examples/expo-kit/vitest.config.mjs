...
const nanostoresReactPath = require.resolve('@nanostores/react', {
    paths: [path.resolve(__dirname, '../../packages/react-native-kit')],
});
...
export default defineConfig({
    ...
    resolve: {
        alias: [
            ...
            {
                find: '@solana-mobile/mobile-wallet-adapter-protocol-kit',
                replacement: path.resolve(__dirname, 'test/mocks/mobile-wallet-adapter-protocol-kit.js'),
            },
            ...
            },
            {
                ...
                replacement: path.resolve(__dirname, '../../packages/react-native-kit/dist/index.node.mjs'),
            },
